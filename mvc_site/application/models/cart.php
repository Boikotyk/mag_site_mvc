  ...
  {	  
    ...
    if($_SESSION['cart']) return true; 
	  ...
	  // формируем интерфейс для работы с корзиной
			$table_cart="<table bgcolor='#E6DEEA' border='1' class='table_cart'><tr><th>№</th><th>Назва</th><th>Вартість</th><th>Кількість</th><th>Загальна вартість</th><th>Видалити</th></tr>";
			$i=1;
			foreach($product_positions as $product)
			{
			...
			$table_cart.="<tr><td colspan='3'></td><td>Оплатити: </td><td><strong> <span style='color: #7F0037'>".$total_summ." грн. </span></strong></td><td></td></tr></table>";
