...
<h1>Каталог товарів</h1>
	...
	<a href="#" rel="creat_new_product" class="button"><img src="design/images/icons/add.png"> Добавити товар</a>
	<br/><br/><b>Категорія товарів</b> <?=$categories?>
	<table class="catalog_table"><tr><th>ID</th><th>Категорія</th><th>Зображення</th><th>Артикул</th><th>Назва</th><th>Опис</th><th>Ціна</th><th></th><th></th></tr>	 
	<?foreach($catalog as $data){?>
		...
		<td><a href="#" rel="edit" id="<?=$data['id']?>">Редагувати</a></td>
		<td><a href="#" rel="del" id="<?=$data['id']?>">Видалити</a></td>
		</tr>
	<?}?>
	...
	<div class="creat_product">
		...
		<tr><td>Ціна:</td><td><input type="text" name="price"/> грн.</td></tr>
		<tr><td>Категорія:</td><td>
				
				<select id='new_prod_category' name='category'>
				<option selected value='0'>Всі</option>
				<?=Lib_Category::getInstance()->getTitleCategory($array_categories);?>	
				</select>
				
				</td></tr>
		<tr><td>Опис:</td><td colspan="2"><textarea name="description" style="width:100%; height: 150px;"></textarea></td></tr>
		<tr>
			<td colspan="3" style="height:40px; text-align:right;">
				<a href="#" rel="save_new_product" class="button" >Зберегти</a>
			</td>
		</tr>
		</table>
	</div>
	...
	<div class="edit_product">
			...
			<table border="1">	
				<tr><td>Назва:</td><td><input type="text" name="edit_name" /></td><td rowspan="4">Зображення:
				...
				<div class="edit_btn_cansel_load_img">
					<a href="#" id="edit_form_del_img"  alt="Відмінити" title="Відмінити"><img  src="design/images/cancal_upload.png"/></a>
				</div>
				...
				<tr><td>Ціна:</td><td><input type="text" name="edit_price"/> грн.</td></tr>
				...
				<tr><td>Опис:</td><td colspan="2"><textarea name="edit_description" style="width:100%; height: 150px;"></textarea></td></tr>
				<tr><td colspan="3" style="height:40px; text-align:right;">
				<a href="#" rel="save_edit_product" class="button" >Зберегти</a>
				</td></tr>
			</table>
